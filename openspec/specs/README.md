...
| [iso-asset-pipeline/spec.md](./iso-asset-pipeline/spec.md) | minimax MCP batch generation + chroma-key postprocess + bootstrap loader | ASSET-001, ASSET-002, ASSET-003, ASSET-004 | ADDED |
